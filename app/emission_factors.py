...
Kaynaklar:
- Elektrik: Türkiye ulusal şebeke emisyon faktörü ~0.478 kg CO2e/kWh
  (ETKB/EVÇED referansı — proje dokümanında belirtilen değer).
- Ulaşım: DEFRA 2024 sera gazı dönüşüm faktörlerinden yuvarlanmış
  yaklaşık değerler (kg CO2e / yolcu-km). Climatiq API entegre edildiğinde
  bu tablo canlı verilerle değiştirilebilir (bkz. tracking.py).
